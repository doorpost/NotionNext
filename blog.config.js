...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '424b3fe206c24927b035f142b6e2ec50',
  PSEUDO_STATIC: true, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: 600, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  SINCE: 2011, // e.g if leave this empty, current year will be used.
  APPEARANCE: 'auto', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式

  AUTHOR: 'DOORPOST', // 作者
  BIO: '靡不有初，鲜克有终', // 作者简介
  LINK: 'https://www.zhangcheng.org', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'doorpost@duck.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: '', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/zhangcheng', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || 'DOORPOST International', // 备案号 闽ICP备XXXXXXX
  ...
  // utterance
  COMMENT_UTTERRANCES_REPO: process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'doorpost/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
